...
/*************************************************************************************************************
* GPIO APIs for Factory Reset Functionality
*************************************************************************************************************/
#include "gpp/mvGpp.h"
EXPORT_SYMBOL(mvGppValueGet);
...
extern int xor_mv(unsigned int src_no, unsigned int bytes, void **bh_ptr);
...
EXPORT_SYMBOL(mvEthPhyCheckLink);
EXPORT_SYMBOL(driverGetPhyID);
...
EXPORT_SYMBOL(mvEthPortPowerUp); 
EXPORT_SYMBOL(mvEthPortPowerDown);
EXPORT_SYMBOL(mvEthSpeedDuplexSet);
EXPORT_SYMBOL(mvEthPortDown);
EXPORT_SYMBOL(mvEthPortUp);
...
EXPORT_SYMBOL(gvlnGetPortVlanPorts);
...
EXPORT_SYMBOL(gvlnSetPortVlanForceDefaultVID);
EXPORT_SYMBOL(gvtuDelEntry);
EXPORT_SYMBOL(gvtuFlush);
EXPORT_SYMBOL(gvtuGetEntryNext);
EXPORT_SYMBOL(gvtuGetEntryFirst);
EXPORT_SYMBOL(gprtSetPortAutoMode);
EXPORT_SYMBOL(gprtSetLearnDisable);
EXPORT_SYMBOL(gprtSetLockedPort);
EXPORT_SYMBOL(gprtPortGetAutoNeg);
EXPORT_SYMBOL(gprtSetPortDuplexMode);
EXPORT_SYMBOL(gprtSetDuplex);
EXPORT_SYMBOL(gprtSetPortSpeed);
EXPORT_SYMBOL(gprtPortAutoNegEnable);
EXPORT_SYMBOL(gprtSetDropOnLock);
EXPORT_SYMBOL(gphyIsFiber);
EXPORT_SYMBOL(gprtGetPhyLinkStatus);
EXPORT_SYMBOL(gprtPortPowerDown);
EXPORT_SYMBOL(hwWriteGlobalReg);
EXPORT_SYMBOL(hwReadGlobalReg);
