...
#define NETDEV_PRINTF_LIST command, name, port
#define NETDEV_SCANF_LIST  &command, name, &port
#define NETDEV_LIST_LEN    3

#define NETDEV_VTU_CMD_STRING  "%2x %d %d"
#define NETDEV_VTU_PRINTF_LIST command, port, tag
#define NETDEV_VTU_SCANF_LIST  &command, &port, &tag
#define NETDEV_VTU_LIST_LEN    3

#define NET_DEV_EN_CMD_STRING	"%2x %d %d"
#define NET_DEV_EN_PRINTF_LIST	command, port, status
#define NET_DEV_EN_SCANF_LIST	&command, &port, &status
#define NET_DEV_EN_LIST_LEN	3
#define NET_DEV_EN_PHY_STR	"wan"
#define NET_DEV_EN_PHY		0
#define NET_DEV_EN_SWITCH_STR	"lan"
#define NET_DEV_EN_SWITCH	1
#define NET_DEV_EN_ON_STR	"on"
#define NET_DEV_EN_ON		1
#define NET_DEV_EN_OFF_STR	"off"
#define NET_DEV_EN_OFF		0
