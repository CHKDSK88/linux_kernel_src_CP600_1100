...
static int s35390a_probe(struct i2c_adapter *adapter, int address, int kind)
{
	int err;
	unsigned int i;
...
static int s35390a_attach(struct i2c_adapter *adapter)
{
	return i2c_probe(adapter, &addr_data, &s35390a_probe);
}
