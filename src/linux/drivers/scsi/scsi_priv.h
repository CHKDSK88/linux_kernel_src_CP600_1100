...
extern void scsi_spinup_sem_up();
extern void scsi_spinup_sem_down();
extern int is_scsi_spinup_enabled();
extern int scsi_spinup_get_timeout();
extern int __init scsi_spinup_init(void);
extern int scsi_do_spinup(struct scsi_cmnd *, unsigned long *);
#else
...
static inline void scsi_spinup_sem_up(void) {}
static inline void scsi_spinup_sem_down(void) {}
static inline void is_scsi_spinup_enabled(void) {}
static inline void scsi_spinup_get_timeout(void) {}
static inline void scsi_do_spinup(void) {}
