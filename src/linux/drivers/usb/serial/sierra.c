...
/* the following is backported from newer kernel */
/**
 * USB_DEVICE_AND_INTERFACE_INFO - describe a specific usb device with
 * a class of usb interfaces
...
static const struct usb_device_id id_table [] = {
	...
	/* Sierra Wireless Direct IP LTE modems 
	{ USB_DEVICE_AND_INTERFACE_INFO(0x1199, 0x0FFF, 0xFF, 0xFF, 0xFF),
	  .driver_info = (kernel_ulong_t)&direct_ip_interface_blacklist 
	},*/
	/* Sierra Wireless Direct IP LTE modems 
