...
/* HS
UNUSUAL_DEV(  0x0681, 0x0041, 0x0000, 0x9999,
		"HC-25",
		"USB Storage",
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		US_FL_IGNORE_DEV),

UNUSUAL_DEV(  0x0041, 0x0681, 0x0000, 0x9999,
	"HC-25",
	"USB Storage",
	US_SC_DEVICE, US_PR_DEVICE, NULL,
	US_FL_IGNORE_DEV),
...
UNUSUAL_DEV(  0x1c9e, 0xf000, 0x0000, 0x0000,
		"USB Modem",
		"USB Modem",
		US_SC_DEVICE, US_PR_DEVICE, hspa_mbd_220HU_init, 0),

UNUSUAL_DEV(  0x106c, 0x3b05, 0x0000, 0x0000,
				"Pantech, Incorporated",
				"UMW190 USB Modem",
				US_SC_DEVICE, US_PR_DEVICE, UMW190_init, 0),
UNUSUAL_DEV(  0x1c9e, 0x98ff, 0x0000, 0x0000,
		"USB Modem",
		"USB Modem",
		US_SC_DEVICE, US_PR_DEVICE, hspa_mbd_220HU_init, 0),
UNUSUAL_DEV(  0x1410, 0x4100, 0x0000, 0x0000,
		"Novatel Wireless Inc",
		"Novatel Wireless CDMA",
		US_SC_DEVICE, US_PR_DEVICE, NULL, US_FL_IGNORE_DEVICE),
UNUSUAL_DEV(  0x1410, 0xb001, 0x0000, 0x0000,
		"Novatel Wireless Inc",
		"Novatel Wireless 4G",
		US_SC_DEVICE, US_PR_DEVICE, NULL, US_FL_IGNORE_DEVICE),
				
UNUSUAL_DEV( 0x1410, 0x7030, 0x0000, 0x0000,
		"Novatel Wireless, Inc",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, NULL, US_FL_IGNORE_DEVICE),

UNUSUAL_DEV( 0x1410, 0x5059, 0x0000, 0x0000,
		"Novatel Wireless, Inc",
		"Novatel Wireless HSPA",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_novatel_mc547_init, 0),

UNUSUAL_DEV(  0x19d2, 0xfff5, 0x0000, 0x0000,
		 "ZTE, Incorporated",
		"USB Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_init, 0),
...
UNUSUAL_DEV( 0x1b7d, 0x0700, 0x0000, 0x0000,
		"EpiValley Incorporated",
		"USB MMC Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_photo_cdma_init,
		0),

UNUSUAL_DEV( 0x1bbb, 0xf000, 0x0000, 0x0000,
		"USBModem",
		"HSPA Data Card",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_hspa_init,
		0),


UNUSUAL_DEV(  0x1410, 0x5010, 0x0000, 0x0000,
		"Novatel Wireless",
		"Novatel Wireless HSUPA Modem",
		US_SC_DEVICE, US_PR_DEVICE, hspa_MC950D_init, 
		0),
UNUSUAL_DEV( 0x11f6, 0x1035, 0x0000, 0xffff,
		"MCXX Wireless",
		"NCXX UX302NC",
		US_SC_DEVICE, US_PR_DEVICE, hspa_NCXX_init, 
		0),
UNUSUAL_DEV( 0x11f6, 0x1032, 0x0000, 0xffff,
		"MCXX Wireless",
		"NCXX UX312NC",
		US_SC_DEVICE, US_PR_DEVICE, hspa_NCXX_init, 
		0),
...
UNUSUAL_DEV( 0x0af0, 0xd357, 0x0000, 0x0000,
		...
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		0 ),
UNUSUAL_DEV( 0x12d1, 0x1f16, 0x0000, 0x9999,
		"HUAWEI",
		"HUAWEI Mobile",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e3276_init,
		0 ),
...
UNUSUAL_DEV( 0x12d1, 0x1446, 0x0000, 0x0000,
		"HUAWEI MOBILE",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e182_init,
		0),
...
UNUSUAL_DEV( 0x12d1, 0x14ad,0x0000,  0x9999,
		...
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e182_init,
		0),
UNUSUAL_DEV( 0x12d1, 0x14ba, 0x0000, 0x0000,
		"HUAWEI Technology",
		"HUAWEI Mobile",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e182_init,
		0),
UNUSUAL_DEV(  0x19d2, 0x0154, 0x0000, 0x0000,
     	"ZTE, Incorporated",
		"USB Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_init2, 0),
UNUSUAL_DEV(  0x19d2, 0x0103, 0x0000, 0x0000,
     	"ZTE, Incorporated",
		"USB Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_init2, 0),
UNUSUAL_DEV( 0x12d1, 0x14c1, 0x0000, 0x0000,
		"Vodafone Group",
...
UNUSUAL_DEV(  0x12d1, 0x1505, 0x0000, 0x0000,
		...
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e182_init,
		0),
UNUSUAL_DEV(  0x12d1, 0x1f01, 0x0000, 0x9999,
		"HUAWEI Technology",
		"HUAWEI MOBILE",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e3276_init,
		0),
UNUSUAL_DEV(  0x12d1, 0x14fe, 0x0000, 0x9999,
		"HUAWEI Technology",
		"HUAWEI MOBILE",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e3276_601_init,
		0),
...
UNUSUAL_DEV( 0x2357, 0xf000, 0x0000, 0x9999,
		"TP-LINK",
		"TP-LINK HSPA+ Modem",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_tplink_init, 0 ),
